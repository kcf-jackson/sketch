testthat::context("Tests for the rewriting and deparsing modules")
...
# Main
testthat::test_that("Test transpilation with basic rules and deparsers", {
...
testthat::test_that("Test transpilation with default rules and deparsers", {
