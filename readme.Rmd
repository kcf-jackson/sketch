...
|:-----------:|:-------------:|:---------------:|
| Assignment of variable| `let (x); x <- 1`      |   `let x; x = 1`              |
...
```{r, eval = FALSE}
sketch::insert_sketch(file = "main.R", width = 800, height = 600)
```
...
### 2.3 [d3.js](https://d3js.org/) {#section-2-3}
